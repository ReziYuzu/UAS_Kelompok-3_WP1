...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost","root","","onlineshoppku");
...
<head>
    ...
    <title>Free Bootstrap Admin Template : OnlineShoppKu</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">OnlineShoppKu</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> Last access : Today &nbsp; <a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
